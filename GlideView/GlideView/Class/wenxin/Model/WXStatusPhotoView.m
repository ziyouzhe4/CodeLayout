...
@implementation WXStatusPhotoView
...
- (void)setPhoto:(WXPhoto *)photo
{
    ...
    [self sd_setImageWithURL:[NSURL URLWithString:photo.thumbnail_pic] placeholderImage:[UIImage imageNamed:@"tab_icon_wo_hl"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
